...
export default {
    ...
    data: () => ({
        defaults: {
            ...
            description: 'Design .vue files with Less Code using Transform Tools and Style Controllers. Drag & Drop Elements and Components into the Template Playground with Vue Play.',
            keywords: 'Vue Play Playground Vue.js Vuejs Drag Drop Design UI Visual Graphic Userinterface',
            author: ''
        }
    }),
    created() {
